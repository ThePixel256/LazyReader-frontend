	...
	return (
		...
		>
			<div className='flex items-center mb-4'>
				...
				<h2 className='text-xl font-semibold text-gray-100'>Eliminar Cuenta</h2>
			</div>
			<p className='text-gray-300 mb-4'>Elimina permanentemente tu cuenta y todo tu contenido.</p>
			<button
